...
import { createDevAppService } from './dev-server/bonjour';
...
function useDevApp(context: BuildContext): boolean {
  return hasConfigValue(context, '--devapp', '-D', 'devapp', true);
}
